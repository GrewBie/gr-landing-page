...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-[70rem] md:h-[90rem] flex items-start justify-center relative"
      ref={containerRef}
    >
      <div
        className="pt-24 md:pt-40 w-full sticky top-0 h-screen flex flex-col items-center justify-center"
      ...
      >
        ...
        >
          <div className="border border-emerald-500/20 rounded-2xl md:rounded-[28px] overflow-hidden bg-black shadow-2xl">
            {children}
          </div>
        </motion.div>
      </div>
